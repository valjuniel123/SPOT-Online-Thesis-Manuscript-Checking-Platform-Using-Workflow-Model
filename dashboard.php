                    ...
                    labels: [
                        <?php
                            $query = "SELECT CONCAT(tbl_userlists.user_lname,', ', tbl_userlists.user_fname,' ',tbl_userlists.user_mname) AS name,
                                    ...
                                    FROM man_checkings 
                                    JOIN tbl_userlists ON man_checkings.man_checker = tbl_userlists.user_id
                                    JOIN man_assignings ON man_checkings.man_id = man_assignings.man_id
                                    WHERE man_assignings.unique_code = '$unique_code' AND man_checkings.date_start>='$datenow' AND man_checkings.com_response>=1
                                    GROUP BY name";
                                    /*
                            $query = "SELECT CONCAT(tbl_userlists.user_lname,', ', tbl_userlists.user_fname,' ',tbl_userlists.user_mname) AS name, 
                                    COUNT(CASE WHEN man_checkings.com_response=1 THEN 1 END) AS counterPen,
...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">            
                    ...
                    <div class="col-xl col-md-6 mb-4">
                        <a href="manuscript_status.php" class="text-decoration-none">
                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        Account Approvals <?php if($user_pos==4){echo " / Dean Codes";}?></div>
        ...
        <!-- Content for Approve and Reject -->
        <div class="row">
            <?php if($user_pos>1){ ?>
            ...
            <div class="col mb-4">
                <?php 
                    ...
                    $manreject_count = 0;
                    while($row = mysqli_fetch_array($sql)) {      
                        $manreject_count = $row['reject_count'];
                    }
                ?>
                <a href="#" class="text-decoration-none">
                    <div class="card border-left-danger shadow h-100 py-2">
