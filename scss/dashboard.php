            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [<?php echo $count[0];?>,<?php echo $count[1];?>, <?php echo $count[2];?>, <?php echo $count[3];?>, <?php echo $count[4];?>, <?php echo $done;?>],
...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col mb-4">
                <?php 
                    $query="SELECT COUNT(man_checkings.man_checker) as pending_count FROM man_checkings WHERE man_checker='$user_name' AND com_response='1'"; 
                    $sql = mysqli_query($conn, $query) or die ("Registration Error: ".mysqli_error($conn));
