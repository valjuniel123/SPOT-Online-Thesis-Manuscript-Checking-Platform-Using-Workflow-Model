...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Upload Manuscript</h1>
        </div>
        ...
        <div class="row">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        ...
                        <p class="mt-1">Please be ensure that the manuscript you were about to upload is in PDF format and with a maximum size of 15mb</p>
                    </div>
                    <div class="card-body">
                    <?php 
                        ...
                        if ($num_row1>0){
                            ...
                            $query = "SELECT * FROM man_assignings WHERE ass_res = '$group_name'";
                            $sql = mysqli_query($conn, $query) or die ("Group Error 2: ".mysqli_error($conn));
                            
                            $num_row2 = mysqli_num_rows($sql);
                            if ($num_row2>0){
                    ?>
                        <div>
                            <p class="mt-1">The group already uploaded the manuscript. Please wait for the panelist to check your manuscript</p>
                        </div>
                    <?php
                            }
                            else{
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="form-adviser" class="form-control" name="adviser" required>
                                            <option value="" disabled selected>--Please select your adviser--</option>
                                            <?php
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="form-panel1"class="form-control" name="panel1" required>
                                            <option value="" disabled selected>--Please select your panel 1--</option>
                                            <?php
                                                $query = "SELECT tbl_userlists.user_id, 
                                                CONCAT(tbl_userlists.user_lname,', ', tbl_userlists.user_fname,' ',tbl_userlists.user_mname) as name
                                                FROM `tbl_userlists` WHERE user_position != 1
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="form-panel2"class="form-control" name="panel2" required>
                                            <option value="" disabled selected>--Please select your panel 2--</option>
                                            <?php
                                                $query = "SELECT tbl_userlists.user_id, 
                                                CONCAT(tbl_userlists.user_lname,', ', tbl_userlists.user_fname,' ',tbl_userlists.user_mname) as name
                                                FROM `tbl_userlists` WHERE user_position != 1
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="form-chair"class="form-control" name="chair" required>
                                            <option value="" disabled selected>--Please select your Chairman--</option>
                                            <?php
                                                $query = "SELECT tbl_userlists.user_id, 
                                                CONCAT(tbl_userlists.user_lname,', ', tbl_userlists.user_fname,' ',tbl_userlists.user_mname) as name
                                                FROM `tbl_userlists` WHERE user_position != 1
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="form-chair"class="form-control" name="dean" required>
                                            <option value="" disabled selected>--Please select your College Dean--</option>
                                            <?php
                                                $query = "SELECT tbl_userlists.user_id, 
                                                CONCAT(tbl_userlists.user_lname,', ', tbl_userlists.user_fname,' ',tbl_userlists.user_mname) as name
                    ...
                    ?>
                        <div>
                            <p class="mt-1">Please Assign Groupings First in Manuscript Status</p>
                        </div>
                    <?php 
                        }
                    ?>
